        ...
        <div class="tablewrapper">
          <table class="member-list">
            ...
            <tbody class="tablebody">
              {members
                .sort((a, b) =>
                  a["availabletime"] < b["availabletime"] ? 1 : -1
                )
                .map((member) => (
                  <tr>
                    <td>
                    ...
                    <td class="member-time">
                      {minToTime(member["availabletime"])}h
                    </td>
                    <td class="member-workload">
                      {Math.round(
                        (member["usedtime"] / member["availabletime"]) * 100
                      )}
                      %
                    </td>
                  </tr>
